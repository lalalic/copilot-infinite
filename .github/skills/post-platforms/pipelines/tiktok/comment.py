#!/usr/bin/env python3
"""
Add a comment or reply on a TikTok video.

Usage:
  python3 comment.py --url https://www.tiktok.com/@user/video/123 --text "Nice!"
  python3 comment.py --url https://www.tiktok.com/@user/video/123 --text "I agree!" --reply-to "Original comment"
"""
...
def main():
    p = argparse.ArgumentParser(description="Add comment or reply on TikTok video")
